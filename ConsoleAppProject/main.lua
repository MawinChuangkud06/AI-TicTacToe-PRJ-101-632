...
function tictactoe:MiniMax(ismaxing, alpha, beta)
    if self:MiniMaxCheckWinner() == self.AI then return 1 end
    if self:MiniMaxCheckWinner() == self.Player then return -1 end
        ...
        for i = 1, 3 do
            for j = 1, 3 do
                if self:IsAbleToFill(i, j) then
                    ...
                    local score = self:MiniMax(false, alpha, beta)
        ...
        for i = 1, 3 do
            for j = 1, 3 do
                if self:IsAbleToFill(i, j) then
                    ...
                    local score = self:MiniMax(true, alpha, beta)
        ...
        for i = 1, 3 do
            for j = 1, 3 do
                if self:IsAbleToFill(i, j) then
                    local temp = self.Board[i][j] 
                    self.Board[i][j] = self.AI
                    local score = self:MiniMax(false, -math.huge, math.huge)
